// scripts/split-state-tax-data-updated.cjs
// Script to split state-tax-data-updated.json into per-state files under public/updated-tax-data/2025/{STATE}.json
