...
export function calculateAndStoreAGI() {
  ...
  const inputs = {
    ...
    adjustments: {
      educator_expenses: 0, // Not currently collected
      health_savings_account_contributions: Number(creditsDeductions.hsaContributions) || 0,
      moving_expenses_for_military: 0, // Not currently collected
      self_employment_tax_deduction: 0, // Not currently collected
      self_employed_health_insurance: 0, // Not currently collected
